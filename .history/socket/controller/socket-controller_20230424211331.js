...
module.exports = class SocketController {
    ...
    selectedToken = async (data) => {
        ...
        if (data) {
            ...
            if (data.token) await this.ludoGame.moveToken(data.token.id, data.userId);
            await this.ludoGame.setDiceCastComplete(false);
            await this.ludoGame.setPlayerTurn(this.gameData.dice_value);
    ...
    diceRoll = async (data) => {
        ...
        if (data) {
            ...
            await this.ludoGame.enableTokens(data.userId);
            await this.sendUpdatedData(data);
        }
    };
