...
module.exports = class SocketController {
    ...
    selectedToken = async (data) => {
        ...
        if (data) {
            ...
            if(retainPos) await this.ludoGame.setDiceCastComplete(true);
            await this.ludoGame.setPlayerTurn(retainPos);
    ...
    diceRoll = async (data) => {
        ...
        if (data) {
            ...
            await this.ludoGame.setDiceCastComplete(true);
            let retainPos = await this.ludoGame.enableTokens(data);
            if(!retainPos) await this.ludoGame.setDiceCastComplete(false);
            await this.ludoGame.setPlayerTurn(retainPos);
            await this.sendUpdatedData(data);
        }
    };
